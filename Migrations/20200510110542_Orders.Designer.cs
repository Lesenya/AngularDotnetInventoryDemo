...
namespace AngularDotnetInventoryDemo.Migrations
{
    ...
    [Migration("20200510110542_Orders")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AngularDotnetInventoryDemo.Models.CartLine", b =>
                {
            ...
            modelBuilder.Entity("AngularDotnetInventoryDemo.Models.Order", b =>
                {
                    b.Property<long>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AngularDotnetInventoryDemo.Models.Payment", b =>
                {
                    b.Property<long>("PaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("AngularDotnetInventoryDemo.Models.CartLine", b =>
                {
                    b.HasOne("AngularDotnetInventoryDemo.Models.Order", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("AngularDotnetInventoryDemo.Models.Order", b =>
                {
                    b.HasOne("AngularDotnetInventoryDemo.Models.Payment", "Payment")
                        .WithMany()
